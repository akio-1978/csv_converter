...
class ConfigTest(J2SRenderTest):
    ...
    def test_merge_parameter(self):
        ...
        expect_file = self.expect_path(J2SRenderTest.CSV, 'merge_parameters.yml')
        result_file = self.result_file()
    ...
    def test_overwrite_parameters(self):
        ...
        expect_file = self.expect_path(J2SRenderTest.CSV, 'overwrite_parameters.yml')
        result_file = self.result_file()
        Runner(args=['csv', 'tests/csv/templates/merge_parameters.tmpl', 'tests/csv/src/parameters.csv', 
            '-o', result_file, '-H',
    ...
    def test_excel_absolute(self):
        ...
        expect_file = self.expect_path(J2SRenderTest.EXCEL, 'read_document.txt')
        result_file = self.result_file()
